...
public class Main {
    public static void main(String[] args) {
        ...
        String author1FirstName = author1.getAuthorName();
        String author1SecondName = author1.getAuthorSecondName();

        Book book1 = new Book(author1FirstName,author1SecondName, "Гарри потный", 3001);
        System.out.println(book1);
        Book book2 = new Book(author2.authorName, author2.authorSecondName, "Тихая сказка", 1955);
